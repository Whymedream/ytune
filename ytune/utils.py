...
class NodeStats:
    ...
    def __repr__(self) -> str:
        return f"<NodeStats total_players={self.players_total!r} playing_active={self.players_active!r}>"
...
class FailingIPBlock:
    ...
    def __repr__(self) -> str:
        return f"<FailingIPBlock address={self.address} failing_time={self.failing_time}>"
...
class RouteStats:
    ...
    def __repr__(self) -> str:
        return f"<RouteStats route_strategy={self.strategy!r} failing_addresses={len(self.failing_addresses)}>"
